...
#include <memory>
#include "../../Connect6changed/mainpage.h"
...
QT_MOC_LITERAL(3, 19, 8) // "sendslot"

    },
    "mainpage\0mysignal\0\0sendslot"
};
...
void mainpage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mainpage::mysignal)) {
                *result = 0;
                return;
            }
        }
